...
def main():
    ...
    xTrain = pd.read_csv(f"../.data/Lithonia/split/xTrain-{args.species}.csv").to_numpy()
    yTrain = pd.read_csv(f"../.data/Lithonia/split/yTrain-{args.species}.csv").to_numpy().flatten()
    xTest = pd.read_csv(f"../.data/Lithonia/split/xTest-{args.species}.csv").to_numpy()
    yTest = pd.read_csv(f"../.data/Lithonia/split/yTest-{args.species}.csv").to_numpy().flatten()
    ...
    with open(f"../.data/Lithonia/hyperParams/{args.species}.json", 'w') as f:
