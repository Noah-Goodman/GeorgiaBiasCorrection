...
def main():
    ...
    xTrain = pd.read_csv(f"../.data/Pittsburgh/split/xTrain-{args.species}.csv").to_numpy()
    yTrain = pd.read_csv(f"../.data/Pittsburgh/split/yTrain-{args.species}.csv").to_numpy().flatten()
    xTest = pd.read_csv(f"../.data/Pittsburgh/split/xTest-{args.species}.csv").to_numpy()
    yTest = pd.read_csv(f"../.data/Pittsburgh/split/yTest-{args.species}.csv").to_numpy().flatten()
    ...
    with open(f"../.data/Pittsburgh/hyperParams/{args.species}.json", 'w') as f:
