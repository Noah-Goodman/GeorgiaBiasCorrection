...
def main():
    ...
    parser.add_argument("species", help="species to model")
    # parser.add_argument("rocOutput",
    #                      help="csv filename for ROC curves")
    args = parser.parse_args()
    # load the train and test data
    xTrain = pd.read_csv(f"../.data/Chapel-Hill/split/xTrain-{args.species}.csv").to_numpy()
    yTrain = pd.read_csv(f"../.data/Chapel-Hill/split/yTrain-{args.species}.csv").to_numpy().flatten()
    xTest = pd.read_csv(f"../.data/Chapel-Hill/split/xTest-{args.species}.csv").to_numpy()
    yTest = pd.read_csv(f"../.data/Chapel-Hill/split/yTest-{args.species}.csv").to_numpy().flatten()
    ...
    with open(f"../.data/Chapel-Hill/hyperParams/{args.species}.json", 'w') as f:
